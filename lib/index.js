...
function requestSigner(options) {
    ...
    if (options.sign !== undefined) {
        ...
        cliSign = options.sign;

        var signOpts = cliSign.options;
        assert.object(signOpts, 'sign.options');

        if (options.mantaSubUser !== undefined)
            signOpts.mantaSubUser = options.mantaSubUser;
        options = signOpts;
    }
    ...
    if (cliSign === undefined)
        cliSign = cliSigner(options);
